    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String description = campo2.getText().toString();
                String price = campo3.getText().toString();


                    //dbHelper.insertData(campo1Insert, campo2Insert, campo3Insert, imageInsert, name);
                    apiOracle.insertProductos(name, description, price,imgSelected);
                    limpiarCampos();
        ...
        btnConsultar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /*Cursor cursor = DBHelper. (name, editId.getText().toString().trim());
                ...
                EditText name = campo1;
                EditText description = campo2;
                EditText price = campo3;
